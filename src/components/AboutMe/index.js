    ...
    return(
        <div className="parent">
            ...
            <section className="about-me">
                ...
                <p>
                    I love spending time with family, cooking, hiking, golf and traveling in my free time. Over the years I've sudied economics, sustainability and graphic design. I graduated from the University of Maryland with a B.S. in Economics and a minor in Sustainability in 2018. Prior to that I recieved my A.A. in Visual Arts.
                </p>
                <p>
